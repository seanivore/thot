# Overview of Thot v1.0.0 'Desk Pad' Build 
...
Thot v1 – Desk Pad is a **single-document macOS text editor**:
...
The golden rule: **SwiftUI controls "what" is shown, AppKit controls "how" text behaves, service modules control "what it means."**
...
**MarkdownTextViewDelegate / subclass:**
  ...
  - Implements IDE-like paired delimiter behavior for `()[]{}''""\``.
